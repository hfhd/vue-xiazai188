  ...
  <div class="zs-hdaoddsinfo">
    <div class="zhegie-wrap">
      <div calss="zhedie-box">
            ...
            <div class="tab-item">
              <div>
                <el-row :gutter="10" class="table-header little-word">
                  ...
                  <el-col :span="4"><div class="grid-content fc">主胜率</div></el-col>
                  <el-col :span="4"><div class="grid-content fc">客胜率</div></el-col>
                  <el-col :span="4"><div class="grid-content fc">返还率</div></el-col>
                </el-row>
                <div class="table-body" v-if="Datass!=undefined && Datass.length!=0">
                  <div  class="pl-list" v-for="(Datas, index) in lastDatas" :key="index" @click="ShowLogs(Datas.Cid)">
                    <el-row :gutter="10">
                      ...
                      <el-col :span="4">
                        <div class="grid-content fc">
                          <span>{{Datas.Data[3]}}%</span>
                        </div>
                      </el-col>
                      <el-col :span="4">
                        <div class="grid-content fc">
                          <span>{{Datas.Data[4]}}%</span>
                        </div>
                      </el-col>
                    </el-row>  
                  </div>        
          ...
          <div class="pl-dialog">
            <el-dialog :title="CurCName + ' 欧赔变化'" :visible.sync="dialogTableVisible" top='10px' width="96%" open="LoadLogs" :cidlog="cidLog">
               <div>
                <el-row :gutter="5" class="table-header little-word">
                  <el-col :span="3"><div class="grid-content fc">公司</div></el-col>
                  <el-col :span="2"><div class="grid-content fc">主赔</div></el-col>
                  <el-col :span="2"><div class="grid-content fc">客赔</div></el-col>
                  <el-col :span="4"><div class="grid-content fc">主胜率</div></el-col>
                  <el-col :span="4"><div class="grid-content fc">客胜率</div></el-col>
                  <el-col :span="4"><div class="grid-content fc">返还率</div></el-col>
                  <el-col :span="5"><div class="grid-content fc">变化时间</div></el-col>
                  ...
                  <div>
                    <div  v-if="CurLogs!=undefined && CurLogs.length!=0">
                      <el-row :gutter="5" class="pl-list" :key="index" v-for="(Logs, index) in CurLogs" >
                        <el-col :span="3" class="company" ><div class="grid-content fc w-blue" v-if="CurCName!=''">{{CurCName}}</div><div v-else>--</div></el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="4">
                          <div class="grid-content fc" v-if="Logs.Data[3]!=undefined && Logs.Data[3]!=''">{{Logs.Data[3]}}%</div>
                          <div class="fc" v-else>--</div>
                        </el-col>  
                        <el-col :span="4">
                          <div class="grid-content fc" v-if="Logs.Data[4]!=undefined && Logs.Data[4]!=''">{{Logs.Data[4]}}%</div>
                          <div class="fc" v-else>--</div>
                        </el-col>
                        <el-col :span="5">
...
export default {
  ...
  created () {
    var hdaoddsinfoUrl = 'live/Api/Api/index/cc/b_hdaoddsinfo/id/' + this.matchid;
